...
// -> main 메서드를 갖고 있는 메인 클래스(Spring3Application)에서 JPA Auditing 기능이 활성화 되어 있는 경우에 
// -> 엔터티(DB에 들어가는 녀석)가 삽입/수정되는 시간이 자동으로 기록되도록 하기 위해서 
// -> AuditingEntityListener: 수정 시간, 작성 시간을 자동으로 기록.
public class BaseTimeEntity {
        ...
        // 마이바티스의 경우 도메인 클래스(entity) 설계 시 db 데이터명과 동일하게 만들었음. 
