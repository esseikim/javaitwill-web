...
<link
    ...
    <!-- rel:  링크된 리소스와 현재 문서와의 관계를 지정하는 역할
    <link> 요소에서 주로 사용되며, 주로 CSS 파일과 관련이 있음.
     현재 문서와 링크된 리소스(여기서는 Bootstrap CSS 파일)가 스타일 시트 파일이라는 것을 의미
     타일 시트 파일은 웹 페이지의 스타일, 레이아웃, 디자인 등을 정의하는 데 사용됨.
       -->
</head>
...
위의 예시 코드에서 링크 텍스트를 클릭하면 /myPage로 이동하며, URL에 param1=value1과 param2=value2가 추가되어 전달될 것
-->
     ...
     <!-- controller에서 jsp로 넘겨준 dto의 변수명과 동일해야 함 -> el로 사용 -->
        <main class="my-2">
            <section  class="card" >
            ...
            <section class="my-2 card">
                ...
                <div class="card-body collapse"  id="replyToggleDiv"> <!-- 보이기 toggle을 위함 -->
                    <!--  내 댓글 등록 -->
                            <div class="my-2 row">
                                     <label class="form-label" for="replyText">나의 댓글</label>
                                            <div class="col-10"> <!-- div: block -> bootrstrap: 12개의 col 중 10개를 사용하겠다. -->
                                                    <textarea class="form-control"  id="replyText"></textarea>
                                                    <input class="d-none" id="writer"  value="admin" /> <!-- d-none: 화면에 안 나옴. -->
                                              </div>
                                
                                           <div class="col-2">
                                                   <button  class="form-control btn btn-outline-success"  id="btnAddReply">등록</button>
                                                      <!-- id: js에서 element 찾아 element 내용 변경을 위함 -->
                                          </div>
                                </div>
                              <!-- 댓글 목록 보여줄 영역 -->
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button"  
                                ...
                                <!--bootstrap에서 data-bs-dismiss="modal"로 eventHandler 등록. -->
