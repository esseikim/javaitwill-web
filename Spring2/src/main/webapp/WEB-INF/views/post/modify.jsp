...
<html>
        ...
        <div class="container-fluid">
               ...
               <main class="my-2">
                        <div class="card">
                            <!-- form의 객체가 가진 submit 될 내용에 대한 name -->
                            <%-- reqest parameter에서 name 속성이 있어야 submit이 됨 + id: for에서 찾기 위해서 --%>
                                ...
                                <div class="d-flex justify-content-center"> <!-- flexible display -->
                                        ...
                                        <button class="mx-2 btn btn-outline-success" id="btnUpdate">업데이트</button>
                                         <!-- form 태그 바깥쪽: 버튼에 이벤트 처리 따로 해야함. css-selector 하고, js- element 찾기 위한 id 속성-->
                                </div>
                        </div>
               </main>
                   ...
                   <!--파일 추가 -> Dispatcher Servlet이 jsp파일을 static 폴더 밑에서 찾게 됨  -->
