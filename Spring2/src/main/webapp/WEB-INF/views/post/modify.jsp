...
<html>
    ...
    <div class="container-fluid">
        ...
        <main class="my-2">
            <div class="card">
                <form class="card-body" id="modifyForm">
                    <div class="my-2">
                        ...
                        <input class="form-control" id="id" 
                            name="id" value="${ post.id }" readonly /> <!-- form 객체가 가진 submit 될 내용에 대한 name. name 속성이 있어야 submit이 됨. -->
                    </div>
                    <div class="my-2">
                ...
                <div class="card-footer">
                    <div class="d-flex justify-content-center"> <!-- flexible display. -->
                    ...
                    </div> <!-- form 태그 외부: 버튼에 이벤트 처리 따로 적용. css-selector 하고, js-element 찾기 위한 id 속성. -->
                </div>
            </div>
        </main>
        ...
        <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/js/bootstrap.bundle.min.js" 
            ...
            crossorigin="anonymous"></script><!-- bootstrap 사용. -->
        <script src="../static/js/post-modify.js"></script> <!-- 파일 추가 > Dispatcher Servlet이 js파일을 static 폴더 밑에서 찾게 됨. -->
    </div>
    </body>
</html>