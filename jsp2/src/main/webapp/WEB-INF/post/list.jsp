...
<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>    
    ...
    3. Postservice  -> 4. PostDao > 5. postDatailContorller -> 6. detail.jsp -->
             ...
             <header>
                ...
                <main>
                        <table>
                                ...
                                <tbody>
                                        <c:forEach items="${post}" var= "post"><!--반복문. post를 통해 접근 가능  for(post post<-변수선언 : posts<- 넘겨받은 애. )-->
                                                  <tr>                            
                                                            <td>${ post.id}</td>  <!-- foreach반복문 통해서 하나씩 꺼내서 post.id를 얻고 -->
                                                            <td>
                        ...
                        <c:url value= "/post/serch" var="serchPage"></c:url>  <!--post를 serch 하는 기능  -->
                        <form action="${serchPage }">
