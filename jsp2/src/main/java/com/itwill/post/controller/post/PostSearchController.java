...
// */
//@WebServlet(name = "postSearchController", urlPatterns = {"/post/search"}) // search 요청이 들어왔을 때 그 요청을 처리하는 Controller.
//
...
//        
//        request.getRequestDispatcher("/WEB-INF/post/list.jsp") // 요청 받고 해당 폴더로 감, forward 방식으로. 
